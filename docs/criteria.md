...
- <span id="criteria-A.2">**A.2**</span>) Does the resource use a standard license?
    ...
    - <span id="criteria-A.2.1">**A.2.2**</span>) No, it is a custom or non-standard license, including public domain declarations: → <span class="no-star">**NO STARS**</span> → <a href="#criteria-B">**B**</a>
